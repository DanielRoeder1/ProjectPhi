...
class Pooling(nn.Module):
    ...
    def __init__(self,
                 ...
                 pooling_mode_prefixtoken: bool = False,
                 num_prefix_token = 0,
                 ):
        super(Pooling, self).__init__()

        self.config_keys = ['word_embedding_dimension', 'pooling_mode_cls_token', 'pooling_mode_mean_tokens', 'pooling_mode_max_tokens',
                            'pooling_mode_mean_sqrt_len_tokens', 'pooling_mode_weightedmean_tokens', 'pooling_mode_lasttoken', 'pooling_mode_prefixtoken', 'num_prefix_token']

        if pooling_mode is not None:        #Set pooling mode by string
            pooling_mode = pooling_mode.lower()
            assert pooling_mode in ['mean', 'max', 'cls', 'weightedmean', 'lasttoken', "prefix"]
            ...
            pooling_prefix_token = (pooling_mode == 'prefix')
        ...
        self.pooling_mode_prefixtoken = pooling_mode_prefixtoken
    ...
    def get_pooling_mode_str(self) -> str:
        ...
        if self.pooling_mode_prefixtoken:
            modes.append("prefix")
    ...
    def forward(self, features: Dict[str, Tensor]):
        ...
        if self.pooling_mode_prefixtoken:
            print("running prefix pooling")
            print(token_embeddings.shape)
            prefix_tokens = token_embeddings[:,:self.num_prefix_token,:]
            prefix_token = prefix_tokens.mean(dim = 1)
            output_vectors.append(prefix_token)
